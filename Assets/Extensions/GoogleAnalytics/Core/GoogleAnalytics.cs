...
public class GoogleAnalytics : MonoBehaviour {
	...
	public const string GOOGLE_ALANALYTICS_CLIENTID_PREF_KEY = "google_alanalytics_clientid_pref_key";
	public const string GOOGLE_ALANALYTICS_SYSTEM_INFO_SUMBITED = "system_info_sumbited";
	...
	public static void SubmitSystemInfo() {
		if(GoogleAnalyticsSettings.Instance.SubmitSystemInfoOnFirstLaunch) {
			if(!PlayerPrefs.HasKey(GOOGLE_ALANALYTICS_SYSTEM_INFO_SUMBITED)) {
				PlayerPrefs.SetInt(GOOGLE_ALANALYTICS_SYSTEM_INFO_SUMBITED, 1);
	...
	public static void RestorePrefKeys() {
		PlayerPrefs.SetString(GOOGLE_ALANALYTICS_CLIENTID_PREF_KEY, _ClientId);
		PlayerPrefs.SetInt(GOOGLE_ALANALYTICS_SYSTEM_INFO_SUMBITED, 1);
	}
	...
	private static void GenerateClientId() {
		if(PlayerPrefs.HasKey(GOOGLE_ALANALYTICS_CLIENTID_PREF_KEY)) {
			_ClientId = PlayerPrefs.GetString(GOOGLE_ALANALYTICS_CLIENTID_PREF_KEY);
		} else {
